    ...
    <div className="flex flex-col h-full bg-gray-900 rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="hidden sm:flex items-center space-x-1 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-sm font-medium transition-colors"
          ...
          <button
            ...
            className="hidden sm:flex items-center space-x-1 px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-white rounded text-sm transition-colors"
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-t border-gray-700 text-xs text-gray-400">
        <div className="flex items-center space-x-4">
          ...
          {draftRestored && <span className="text-emerald-300">已恢复草稿</span>}
        </div>
        <div className="flex items-center space-x-2">
          <span className="text-gray-500">Ctrl/Cmd+Enter</span>
          <span>执行</span>
          <span className="text-gray-500">Ctrl/Cmd+/</span>
          <span>注释</span>
          <span className="text-gray-500">Ctrl/Cmd+Shift+F</span>
          <span>格式化</span>
        </div>
      </div>
